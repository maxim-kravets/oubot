...
{
    public function start(?string $additional_text_to_header = null): void
    {
    ...
    function info(?int $id = null): void
    {
        ...
        $keyboard = (new Keyboard())
            ...
            ->row([
                'text' => '📝 Промокод',
                'callback_data' => json_encode([
                    'c' => self::COMMAND_PROMOCODES_EDIT_NAME,
                    'id' => $promocode->getId()
                ])
            ], [
                'text' => '📝 Товар',
            ...
            ->row([
                'text' => '📝 Дата',
                'callback_data' => json_encode([
                    'c' => self::COMMAND_PROMOCODES_EDIT_EXPIRE,
                    'id' => $promocode->getId()
                ])
            ], [
                'text' => '📝 Скидка',
                'callback_data' => json_encode([
                    'c' => self::COMMAND_PROMOCODES_EDIT_DISCOUNT,
                    'id' => $promocode->getId()
                ])
            ])
            ->row([
